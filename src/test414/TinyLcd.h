...
#define SETDISP_PORT PORTA.DIRSET = 0xFC

#define DISP_E_0 PORTA.OUT &= ~(1<<2)  // LCD signals definition
#define DISP_E_1 PORTA.OUT |= 1<<2
#define DISP_INST PORTA.OUT &= ~(1<<3)
#define DISP_DATA PORTA.OUT |= 1<<3
#define DISP_DB7_0 PORTA.OUT &= ~(1<<7)
#define DISP_DB7_1 PORTA.OUT |= 1<<7
#define DISP_DB6_0 PORTA.OUT &= ~(1<<6)
#define DISP_DB6_1 PORTA.OUT |= 1<<6
#define DISP_DB5_0 PORTA.OUT &= ~(1<<5)
#define DISP_DB5_1 PORTA.OUT |= 1<<5
#define DISP_DB4_0 PORTA.OUT &= ~(1<<4)
#define DISP_DB4_1 PORTA.OUT |= 1<<4
