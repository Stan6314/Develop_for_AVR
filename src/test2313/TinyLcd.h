...
#define SETDISP_PORT DDRD |= 0x3F

#define DISP_E_0 PORTD &= ~(1<<1)  // LCD signals definition
#define DISP_E_1 PORTD |= 1<<1
#define DISP_INST PORTD &= ~(1)
#define DISP_DATA PORTD |= 1
#define DISP_DB7_0 PORTD &= ~(1<<5)
#define DISP_DB7_1 PORTD |= 1<<5
#define DISP_DB6_0 PORTD &= ~(1<<4)
#define DISP_DB6_1 PORTD |= 1<<4
#define DISP_DB5_0 PORTD &= ~(1<<3)
#define DISP_DB5_1 PORTD |= 1<<3
#define DISP_DB4_0 PORTD &= ~(1<<2)
#define DISP_DB4_1 PORTD |= 1<<2
