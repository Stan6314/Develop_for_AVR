...
#define SETDISP_PORT PORTD.DIRSET = 0x7E

#define DISP_E_0 PORTD.OUT &= ~(1<<2)  // LCD signals definition
#define DISP_E_1 PORTD.OUT |= 1<<2
#define DISP_INST PORTD.OUT &= ~(1<<1)
#define DISP_DATA PORTD.OUT |= 1<<1
#define DISP_DB7_0 PORTD.OUT &= ~(1<<6)
#define DISP_DB7_1 PORTD.OUT |= 1<<6
#define DISP_DB6_0 PORTD.OUT &= ~(1<<5)
#define DISP_DB6_1 PORTD.OUT |= 1<<5
#define DISP_DB5_0 PORTD.OUT &= ~(1<<4)
#define DISP_DB5_1 PORTD.OUT |= 1<<4
#define DISP_DB4_0 PORTD.OUT &= ~(1<<3)
#define DISP_DB4_1 PORTD.OUT |= 1<<3
